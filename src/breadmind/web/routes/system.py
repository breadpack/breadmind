...
def setup_system_routes(r: APIRouter, app_state):
    ...
    @r.post("/api/messenger/{platform}/auto-connect")
    ...
    @r.post("/api/messenger/wizard/{session_id}/step")
    ...
    @r.get("/api/messenger/wizard/{session_id}/status")
    ...
    @r.delete("/api/messenger/wizard/{session_id}")
    ...
    @r.get("/api/messenger/lifecycle/status")
    ...
    @r.post("/api/messenger/lifecycle/{platform}/restart")
    ...
    @r.get("/api/messenger/lifecycle/health")
    ...
    @r.get("/api/messenger/security/logs")
    ...
    @r.get("/api/messenger/security/{platform}/expiry")
