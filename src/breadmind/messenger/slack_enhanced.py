...
from typing import Any  # noqa: F401 (used in Task 22+)

from breadmind.messenger.router import IncomingMessage  # noqa: F401 (used in Task 22+)
...
class SlackEnhancedGateway(SlackGateway):
    ...
    def __init__(
        ...
        on_feedback: Callable | None = None,  # noqa: F841 (used in Task 23+)
    ) -> None:
